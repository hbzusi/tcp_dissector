...
tastaturzuordnungen = {
  ...
  [0x5E] = "Führertisch deaktivieren",
  [0x5F] = "Antriebsaktivierung",
}
...
indusi_einstellungen = {
  ...
  attributes = {
    [0x0001] = { typ = "byte", name = "Zugart", enum = zugart },
    ...
    [0x000A] = { typ = "byte", name = "Luftabsperrhahn", enum = abgesperrt_offen },
    ...
    [0x000C] = { typ = "byte", name = "Funktionsprüfung", enum = funktionspruefung },
    [0x000D] = { typ = "byte", name = "Systemstatus (Indusi)", enum = systemstatus },
    [0x000E] = { typ = "string", name = "Bauart Zugbeeinflussungssystem", },
    [0x000F] = { typ = "byte", name = "Indusi-Störschalterbauart", enum = schalterbauart },
    [0x0010] = { typ = "byte", name = "LZB-Störschalterbauart", enum = schalterbauart },
  ...
  nodes = {
    [0x0004] = {
      ...
      attributes = {
        ...
        [0x0005] = { typ = "byte", name = "Zugehörige Zugart", enum = zugart },
      },
    },
    [0x0005] = {
      name = "Ersatzzugdaten",
...
etcs_einstellungen_interaktionen = {
  ...
  attributes = {
    ...
    [0x0007] = { typ = "byte", name = "Luftabsperrhahn", enum = abgesperrt_offen },
      ...
      nodes = {
          ...
          nodes = {
            ...
            [0x0064] = {
              ...
              attributes = {
                ...
                [0x0006] = { typ = "byte", name = "Sifa-Luftabsperrhahn", enum = abgesperrt_offen },
                ...
                [0x0003] = {
                  ...
                  nodes = {
                    [0x000E] = {
                      ...
                      attributes = {
                        [0x0001] = { typ = "byte", name = "Status", enum = eingeleitet_quittiert },
                      },
                    },
                  ...
                  attributes = {
                    ...
                    [0x0003] = { typ = "word", name = "Zwangsbremsung", enum = grund_zwangsbremsung, },
                    ...
                    [0x0024] = { typ = "byte", name = "Melder G", enum = aus_dauerlicht_blinkend },
                    [0x0025] = { typ = "byte", name = "Melder Prüf/Stör", enum = aus_dauerlicht_blinkend },
                  ...
                  nodes = {
                    ...
                    [0x0006] = {
                      ...
                      attributes = {
                        ...
                        [0x0002] = { typ = "byte", name = "Quittierung", enum = etcs_quittierung},
                      },
                    },
                    [0x0007] = {
            ...
            [0x008D] = {
              ...
              attributes = {
                ...
                [0x0009] = { typ = "byte", name = "Status automatischer Angleicher", enum = {
                  [0] = "Normalbetrieb",
                  ...
                  nodes = {
                    ...
                    [0x0025] = {
                      ...
                      attributes = {
                        ...
                        [0x0004] = { typ = "single", name = "Max. Kraft in N", },
                      },
                    },
                    [0x0026] = {
              ...
              nodes = {
                [0x0001] = {
                  ...
                  attributes = {
                    ...
                    [0x0004] = { typ = "single", name = "Motordrehzahl 1 in U/min", },
                    ...
                    [0x0007] = { typ = "byte", name = "Absperrhähne Hauptluftleitung", enum = absperrhaehne_status},
                    [0x000C] = { typ = "single", name = "Bremszylinderdruck 2 in bar", },
                    [0x000D] = { typ = "byte", name = "Absperrhähne Hauptlufbehältertleitung", enum = absperrhaehne_status},
                    [0x000E] = { typ = "byte", name = "Zustand Magnetschienenbremse", enum = {
                      [0] = "Magnet oben und nicht bestromt",
                      [1] = "Magnet unten und nicht bestromt",
                    ...
                    [0x0010] = { typ = "byte", name = "Zustand Mg-Bremsen-Manipulation", enum = { 
                      -- bitweise
                      [1] = "Bremse senkt ab",
          ...
          nodes = {
            ...
            [0x0004] = {
              ...
              attributes = {
                ...
                [0x0003] = { typ = "byte", name = "Luftabsperrhahn", enum = abgesperrt_offen },
        ...
        [0x010B] = {
          ...
          nodes = {
            ...
            [0x000E] = {
              name = "Fahrzeugbilder",
              attributes = {
                [0x0001] = { typ = "word", name = "Bildhöhe in Pixel", },
        ...
        [0x010C] = {
          ...
          attributes = {
            ...
            [0x0005] = { typ = "data", name = "Serialisierte Bitmap-Datei", },
